...
urlpatterns = [
    ...
    path("photos/<int:photo_id>/detail/", blog.views.photos_detail, name="photos_detail"),
    path("photos/<int:photo_id>/update/", blog.views.photos_update, name="photos_update"),
    path("photos/<int:photo_id>/delete/", blog.views.photos_delete, name="photos_delete"),
    path("posts/", blog.views.posts_view, name="posts"),
    path("posts/add/", blog.views.post_and_photo_add, name="posts_add"),
    path("posts/<int:post_id>/detail/", blog.views.posts_detail, name="posts_detail"),
    path("posts/<int:post_id>/update/", blog.views.posts_update, name="posts_update"),
    path("posts/<int:post_id>/delete/", blog.views.posts_delete, name="posts_delete"),
